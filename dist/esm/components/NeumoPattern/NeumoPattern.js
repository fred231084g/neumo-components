import{__decorate as t,__metadata as e}from"../../node_modules/tslib/tslib.es6.js";import{css as n,LitElement as r,html as i,nothing as s}from"lit";import{property as a,customElement as o}from"lit/decorators.js";import{classMap as d}from"../../node_modules/lit-html/directives/class-map.js";let p=class extends r{constructor(){super(...arguments),this.pattern="z",this.loading=!1,this.content={main:""},this.withDropCap=!1,this.role=null,this.ariaLabel=null}render(){const t={"pattern-container":!0,[`${this.pattern}-pattern`]:!0};return i`
      <div class=${d(t)} 
           role=${this.role||s}
  ...
  `,t([a({type:String}),e("design:type",String)],p.prototype,"pattern",void 0),t([a({type:Boolean}),e("design:type",Object)],p.prototype,"loading",void 0),t([a({type:Object}),e("design:type",Object)],p.prototype,"content",void 0),t([a({type:Boolean}),e("design:type",Object)],p.prototype,"withDropCap",void 0),t([a({type:String}),e("design:type",Object)],p.prototype,"role",void 0),t([a({type:String}),e("design:type",Object)],p.prototype,"ariaLabel",void 0),p=t([o("neumo-pattern")],p);let c=class extends p{constructor(){super(),this.pattern="z"}};c=t([o("neumo-z-pattern"),e("design:paramtypes",[])],c);let l=class extends p{constructor(){super(),this.pattern="f"}};l=t([o("neumo-f-pattern"),e("design:paramtypes",[])],l);let h=class extends p{constructor(){super(),this.pattern="t"}};h=t([o("neumo-t-pattern"),e("design:paramtypes",[])],h);export{l as NeumoFPattern,p as NeumoPattern,h as NeumoTPattern,c as NeumoZPattern};
