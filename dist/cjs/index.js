"use strict";var t=require("lit"),e=require("lit/decorators.js");function r(t,e,r,i){var s,o=arguments.length,n=o<3?e:null===i?i=Object.getOwnPropertyDescriptor(e,r):i;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)n=Reflect.decorate(t,e,r,i);else for(var a=t.length-1;a>=0;a--)(s=t[a])&&(n=(o<3?s(n):o>3?s(e,r,n):s(e,r))||n);return o>3&&n&&Object.defineProperty(e,r,n),n}function i(t,e){if("object"==typeof Reflect&&"function"==typeof Reflect.metadata)return Reflect.metadata(t,e)}"function"==typeof SuppressedError&&SuppressedError;const s=globalThis,o=s.trustedTypes,n=o?o.createPolicy("lit-html",{createHTML:t=>t}):void 0,a="$lit$",p=`lit$${Math.random().toFixed(9).slice(2)}$`,d="?"+p,h=`<${d}>`,l=document,c=()=>l.createComment(""),u=t=>null===t||"object"!=typeof t&&"function"!=typeof t,m=Array.isArray,g="[ \t\n\f\r]",y=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,v=/-->/g,f=/>/g,$=RegExp(`>|${g}(?:([^\\s"'>=/]+)(${g}*=${g}*(?:[^ \t\n\f\r"'\`<>=]|("|')|))|$)`,"g"),_=/'/g,b=/"/g,x=/^(?:script|style|textarea|title)$/i,A=Symbol.for("lit-noChange"),N=Symbol.for("lit-nothing"),C=new WeakMap,w=l.createTreeWalker(l,129);function S(t,e){if(!m(t)||!t.hasOwnProperty("raw"))throw Error("invalid template strings array");return void 0!==n?n.createHTML(e):e}const k=(t,e)=>{const r=t.length-1,i=[];let s,o=2===e?"<svg>":3===e?"<math>":"",n=y;for(let e=0;e<r;e++){const r=t[e];let d,l,c=-1,u=0;for(;u<r.length&&(n.lastIndex=u,l=n.exec(r),null!==l);)u=n.lastIndex,n===y?"!--"===l[1]?n=v:void 0!==l[1]?n=f:void 0!==l[2]?(x.test(l[2])&&(s=RegExp("</"+l[2],"g")),n=$):void 0!==l[3]&&(n=$):n===$?">"===l[0]?(n=s??y,c=-1):void 0===l[1]?c=-2:(c=n.lastIndex-l[2].length,d=l[1],n=void 0===l[3]?$:'"'===l[3]?b:_):n===b||n===_?n=$:n===v||n===f?n=y:(n=$,s=void 0);const m=n===$&&t[e+1].startsWith("/>")?" ":"";o+=n===y?r+h:c>=0?(i.push(d),r.slice(0,c)+a+r.slice(c)+p+m):r+p+(-2===c?e:m)}return[S(t,o+(t[r]||"<?>")+(2===e?"</svg>":3===e?"</math>":"")),i]};class B{constructor({strings:t,_$litType$:e},r){let i;this.parts=[];let s=0,n=0;const h=t.length-1,l=this.parts,[u,m]=k(t,e);if(this.el=B.createElement(u,r),w.currentNode=this.el.content,2===e||3===e){const t=this.el.content.firstChild;t.replaceWith(...t.childNodes)}for(;null!==(i=w.nextNode())&&l.length<h;){if(1===i.nodeType){if(i.hasAttributes())for(const t of i.getAttributeNames())if(t.endsWith(a)){const e=m[n++],r=i.getAttribute(t).split(p),o=/([.?@])?(.*)/.exec(e);l.push({type:1,index:s,name:o[2],strings:r,ctor:"."===o[1]?z:"?"===o[1]?M:"@"===o[1]?R:T}),i.removeAttribute(t)}else t.startsWith(p)&&(l.push({type:6,index:s}),i.removeAttribute(t));if(x.test(i.tagName)){const t=i.textContent.split(p),e=t.length-1;if(e>0){i.textContent=o?o.emptyScript:"";for(let r=0;r<e;r++)i.append(t[r],c()),w.nextNode(),l.push({type:2,index:++s});i.append(t[e],c())}}}else if(8===i.nodeType)if(i.data===d)l.push({type:2,index:s});else{let t=-1;for(;-1!==(t=i.data.indexOf(p,t+1));)l.push({type:7,index:s}),t+=p.length-1}s++}}static createElement(t,e){const r=l.createElement("template");return r.innerHTML=t,r}}function E(t,e,r=t,i){if(e===A)return e;let s=void 0!==i?r._$Co?.[i]:r._$Cl;const o=u(e)?void 0:e._$litDirective$;return s?.constructor!==o&&(s?._$AO?.(!1),void 0===o?s=void 0:(s=new o(t),s._$AT(t,r,i)),void 0!==i?(r._$Co??=[])[i]=s:r._$Cl=s),void 0!==s&&(e=E(t,s._$AS(t,e.values),s,i)),e}class P{constructor(t,e){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=e}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(t){const{el:{content:e},parts:r}=this._$AD,i=(t?.creationScope??l).importNode(e,!0);w.currentNode=i;let s=w.nextNode(),o=0,n=0,a=r[0];for(;void 0!==a;){if(o===a.index){let e;2===a.type?e=new H(s,s.nextSibling,this,t):1===a.type?e=new a.ctor(s,a.name,a.strings,this,t):6===a.type&&(e=new L(s,this,t)),this._$AV.push(e),a=r[++n]}o!==a?.index&&(s=w.nextNode(),o++)}return w.currentNode=l,i}p(t){let e=0;for(const r of this._$AV)void 0!==r&&(void 0!==r.strings?(r._$AI(t,r,e),e+=r.strings.length-2):r._$AI(t[e])),e++}}class H{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(t,e,r,i){this.type=2,this._$AH=N,this._$AN=void 0,this._$AA=t,this._$AB=e,this._$AM=r,this.options=i,this._$Cv=i?.isConnected??!0}get parentNode(){let t=this._$AA.parentNode;const e=this._$AM;return void 0!==e&&11===t?.nodeType&&(t=e.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,e=this){t=E(this,t,e),u(t)?t===N||null==t||""===t?(this._$AH!==N&&this._$AR(),this._$AH=N):t!==this._$AH&&t!==A&&this._(t):void 0!==t._$litType$?this.$(t):void 0!==t.nodeType?this.T(t):(t=>m(t)||"function"==typeof t?.[Symbol.iterator])(t)?this.k(t):this._(t)}O(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}T(t){this._$AH!==t&&(this._$AR(),this._$AH=this.O(t))}_(t){this._$AH!==N&&u(this._$AH)?this._$AA.nextSibling.data=t:this.T(l.createTextNode(t)),this._$AH=t}$(t){const{values:e,_$litType$:r}=t,i="number"==typeof r?this._$AC(t):(void 0===r.el&&(r.el=B.createElement(S(r.h,r.h[0]),this.options)),r);if(this._$AH?._$AD===i)this._$AH.p(e);else{const t=new P(i,this),r=t.u(this.options);t.p(e),this.T(r),this._$AH=t}}_$AC(t){let e=C.get(t.strings);return void 0===e&&C.set(t.strings,e=new B(t)),e}k(t){m(this._$AH)||(this._$AH=[],this._$AR());const e=this._$AH;let r,i=0;for(const s of t)i===e.length?e.push(r=new H(this.O(c()),this.O(c()),this,this.options)):r=e[i],r._$AI(s),i++;i<e.length&&(this._$AR(r&&r._$AB.nextSibling,i),e.length=i)}_$AR(t=this._$AA.nextSibling,e){for(this._$AP?.(!1,!0,e);t&&t!==this._$AB;){const e=t.nextSibling;t.remove(),t=e}}setConnected(t){void 0===this._$AM&&(this._$Cv=t,this._$AP?.(t))}}class T{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(t,e,r,i,s){this.type=1,this._$AH=N,this._$AN=void 0,this.element=t,this.name=e,this._$AM=i,this.options=s,r.length>2||""!==r[0]||""!==r[1]?(this._$AH=Array(r.length-1).fill(new String),this.strings=r):this._$AH=N}_$AI(t,e=this,r,i){const s=this.strings;let o=!1;if(void 0===s)t=E(this,t,e,0),o=!u(t)||t!==this._$AH&&t!==A,o&&(this._$AH=t);else{const i=t;let n,a;for(t=s[0],n=0;n<s.length-1;n++)a=E(this,i[r+n],e,n),a===A&&(a=this._$AH[n]),o||=!u(a)||a!==this._$AH[n],a===N?t=N:t!==N&&(t+=(a??"")+s[n+1]),this._$AH[n]=a}o&&!i&&this.j(t)}j(t){t===N?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,t??"")}}class z extends T{constructor(){super(...arguments),this.type=3}j(t){this.element[this.name]=t===N?void 0:t}}class M extends T{constructor(){super(...arguments),this.type=4}j(t){this.element.toggleAttribute(this.name,!!t&&t!==N)}}class R extends T{constructor(t,e,r,i,s){super(t,e,r,i,s),this.type=5}_$AI(t,e=this){if((t=E(this,t,e,0)??N)===A)return;const r=this._$AH,i=t===N&&r!==N||t.capture!==r.capture||t.once!==r.once||t.passive!==r.passive,s=t!==N&&(r===N||i);i&&this.element.removeEventListener(this.name,this,r),s&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){"function"==typeof this._$AH?this._$AH.call(this.options?.host??this.element,t):this._$AH.handleEvent(t)}}class L{constructor(t,e,r){this.element=t,this.type=6,this._$AN=void 0,this._$AM=e,this.options=r}get _$AU(){return this._$AM._$AU}_$AI(t){E(this,t)}}const j=s.litHtmlPolyfillSupport;j?.(B,H),(s.litHtmlVersions??=[]).push("3.2.1");const D=1;class O{constructor(t){}get _$AU(){return this._$AM._$AU}_$AT(t,e,r){this._$Ct=t,this._$AM=e,this._$Ci=r}_$AS(t,e){return this.update(t,e)}update(t,e){return this.render(...e)}}const I=(t=>(...e)=>({_$litDirective$:t,values:e}))(class extends O{constructor(t){if(super(t),t.type!==D||"class"!==t.name||t.strings?.length>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(t){return" "+Object.keys(t).filter((e=>t[e])).join(" ")+" "}update(t,[e]){if(void 0===this.st){this.st=new Set,void 0!==t.strings&&(this.nt=new Set(t.strings.join(" ").split(/\s/).filter((t=>""!==t))));for(const t in e)e[t]&&!this.nt?.has(t)&&this.st.add(t);return this.render(e)}const r=t.element.classList;for(const t of this.st)t in e||(r.remove(t),this.st.delete(t));for(const t in e){const i=!!e[t];i===this.st.has(t)||this.nt?.has(t)||(i?(r.add(t),this.st.add(t)):(r.remove(t),this.st.delete(t)))}return A}});exports.NeumoPattern=class extends t.LitElement{constructor(){super(...arguments),this.pattern="z",this.loading=!1,this.content={main:""},this.withDropCap=!1}render(){const e={"pattern-container":!0,[`${this.pattern}-pattern`]:!0};return t.html`
      <div class=${I(e)} 
