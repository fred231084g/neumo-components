!function(t,e){"object"==typeof exports&&"undefined"!=typeof module?e(exports,require("lit"),require("lit/decorators.js")):"function"==typeof define&&define.amd?define(["exports","lit","lit/decorators.js"],e):e((t="undefined"!=typeof globalThis?globalThis:t||self).NeumoComponents={},t.Lit,t.LitDecorators)}(this,(function(t,e,i){"use strict";function n(t,e,i,n){var r,o=arguments.length,s=o<3?e:null===n?n=Object.getOwnPropertyDescriptor(e,i):n;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(t,e,i,n);else for(var a=t.length-1;a>=0;a--)(r=t[a])&&(s=(o<3?r(s):o>3?r(e,i,s):r(e,i))||s);return o>3&&s&&Object.defineProperty(e,i,s),s}function r(t,e){if("object"==typeof Reflect&&"function"==typeof Reflect.metadata)return Reflect.metadata(t,e)}"function"==typeof SuppressedError&&SuppressedError;const o=globalThis,s=o.trustedTypes,a=s?s.createPolicy("lit-html",{createHTML:t=>t}):void 0,d="$lit$",h=`lit$${Math.random().toFixed(9).slice(2)}$`,p="?"+h,l=`<${p}>`,c=document,u=()=>c.createComment(""),m=t=>null===t||"object"!=typeof t&&"function"!=typeof t,g=Array.isArray,y="[ \t\n\f\r]",f=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,v=/-->/g,$=/>/g,_=RegExp(`>|${y}(?:([^\\s"'>=/]+)(${y}*=${y}*(?:[^ \t\n\f\r"'\`<>=]|("|')|))|$)`,"g"),b=/'/g,A=/"/g,N=/^(?:script|style|textarea|title)$/i,x=Symbol.for("lit-noChange"),C=Symbol.for("lit-nothing"),w=new WeakMap,S=c.createTreeWalker(c,129);function k(t,e){if(!g(t)||!t.hasOwnProperty("raw"))throw Error("invalid template strings array");return void 0!==a?a.createHTML(e):e}const B=(t,e)=>{const i=t.length-1,n=[];let r,o=2===e?"<svg>":3===e?"<math>":"",s=f;for(let e=0;e<i;e++){const i=t[e];let a,p,c=-1,u=0;for(;u<i.length&&(s.lastIndex=u,p=s.exec(i),null!==p);)u=s.lastIndex,s===f?"!--"===p[1]?s=v:void 0!==p[1]?s=$:void 0!==p[2]?(N.test(p[2])&&(r=RegExp("</"+p[2],"g")),s=_):void 0!==p[3]&&(s=_):s===_?">"===p[0]?(s=r??f,c=-1):void 0===p[1]?c=-2:(c=s.lastIndex-p[2].length,a=p[1],s=void 0===p[3]?_:'"'===p[3]?A:b):s===A||s===b?s=_:s===v||s===$?s=f:(s=_,r=void 0);const m=s===_&&t[e+1].startsWith("/>")?" ":"";o+=s===f?i+l:c>=0?(n.push(a),i.slice(0,c)+d+i.slice(c)+h+m):i+h+(-2===c?e:m)}return[k(t,o+(t[i]||"<?>")+(2===e?"</svg>":3===e?"</math>":"")),n]};class E{constructor({strings:t,_$litType$:e},i){let n;this.parts=[];let r=0,o=0;const a=t.length-1,l=this.parts,[c,m]=B(t,e);if(this.el=E.createElement(c,i),S.currentNode=this.el.content,2===e||3===e){const t=this.el.content.firstChild;t.replaceWith(...t.childNodes)}for(;null!==(n=S.nextNode())&&l.length<a;){if(1===n.nodeType){if(n.hasAttributes())for(const t of n.getAttributeNames())if(t.endsWith(d)){const e=m[o++],i=n.getAttribute(t).split(h),s=/([.?@])?(.*)/.exec(e);l.push({type:1,index:r,name:s[2],strings:i,ctor:"."===s[1]?L:"?"===s[1]?M:"@"===s[1]?R:z}),n.removeAttribute(t)}else t.startsWith(h)&&(l.push({type:6,index:r}),n.removeAttribute(t));if(N.test(n.tagName)){const t=n.textContent.split(h),e=t.length-1;if(e>0){n.textContent=s?s.emptyScript:"";for(let i=0;i<e;i++)n.append(t[i],u()),S.nextNode(),l.push({type:2,index:++r});n.append(t[e],u())}}}else if(8===n.nodeType)if(n.data===p)l.push({type:2,index:r});else{let t=-1;for(;-1!==(t=n.data.indexOf(h,t+1));)l.push({type:7,index:r}),t+=h.length-1}r++}}static createElement(t,e){const i=c.createElement("template");return i.innerHTML=t,i}}function P(t,e,i=t,n){if(e===x)return e;let r=void 0!==n?i._$Co?.[n]:i._$Cl;const o=m(e)?void 0:e._$litDirective$;return r?.constructor!==o&&(r?._$AO?.(!1),void 0===o?r=void 0:(r=new o(t),r._$AT(t,i,n)),void 0!==n?(i._$Co??=[])[n]=r:i._$Cl=r),void 0!==r&&(e=P(t,r._$AS(t,e.values),r,n)),e}class T{constructor(t,e){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=e}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(t){const{el:{content:e},parts:i}=this._$AD,n=(t?.creationScope??c).importNode(e,!0);S.currentNode=n;let r=S.nextNode(),o=0,s=0,a=i[0];for(;void 0!==a;){if(o===a.index){let e;2===a.type?e=new H(r,r.nextSibling,this,t):1===a.type?e=new a.ctor(r,a.name,a.strings,this,t):6===a.type&&(e=new j(r,this,t)),this._$AV.push(e),a=i[++s]}o!==a?.index&&(r=S.nextNode(),o++)}return S.currentNode=c,n}p(t){let e=0;for(const i of this._$AV)void 0!==i&&(void 0!==i.strings?(i._$AI(t,i,e),e+=i.strings.length-2):i._$AI(t[e])),e++}}class H{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(t,e,i,n){this.type=2,this._$AH=C,this._$AN=void 0,this._$AA=t,this._$AB=e,this._$AM=i,this.options=n,this._$Cv=n?.isConnected??!0}get parentNode(){let t=this._$AA.parentNode;const e=this._$AM;return void 0!==e&&11===t?.nodeType&&(t=e.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,e=this){t=P(this,t,e),m(t)?t===C||null==t||""===t?(this._$AH!==C&&this._$AR(),this._$AH=C):t!==this._$AH&&t!==x&&this._(t):void 0!==t._$litType$?this.$(t):void 0!==t.nodeType?this.T(t):(t=>g(t)||"function"==typeof t?.[Symbol.iterator])(t)?this.k(t):this._(t)}O(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}T(t){this._$AH!==t&&(this._$AR(),this._$AH=this.O(t))}_(t){this._$AH!==C&&m(this._$AH)?this._$AA.nextSibling.data=t:this.T(c.createTextNode(t)),this._$AH=t}$(t){const{values:e,_$litType$:i}=t,n="number"==typeof i?this._$AC(t):(void 0===i.el&&(i.el=E.createElement(k(i.h,i.h[0]),this.options)),i);if(this._$AH?._$AD===n)this._$AH.p(e);else{const t=new T(n,this),i=t.u(this.options);t.p(e),this.T(i),this._$AH=t}}_$AC(t){let e=w.get(t.strings);return void 0===e&&w.set(t.strings,e=new E(t)),e}k(t){g(this._$AH)||(this._$AH=[],this._$AR());const e=this._$AH;let i,n=0;for(const r of t)n===e.length?e.push(i=new H(this.O(u()),this.O(u()),this,this.options)):i=e[n],i._$AI(r),n++;n<e.length&&(this._$AR(i&&i._$AB.nextSibling,n),e.length=n)}_$AR(t=this._$AA.nextSibling,e){for(this._$AP?.(!1,!0,e);t&&t!==this._$AB;){const e=t.nextSibling;t.remove(),t=e}}setConnected(t){void 0===this._$AM&&(this._$Cv=t,this._$AP?.(t))}}class z{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(t,e,i,n,r){this.type=1,this._$AH=C,this._$AN=void 0,this.element=t,this.name=e,this._$AM=n,this.options=r,i.length>2||""!==i[0]||""!==i[1]?(this._$AH=Array(i.length-1).fill(new String),this.strings=i):this._$AH=C}_$AI(t,e=this,i,n){const r=this.strings;let o=!1;if(void 0===r)t=P(this,t,e,0),o=!m(t)||t!==this._$AH&&t!==x,o&&(this._$AH=t);else{const n=t;let s,a;for(t=r[0],s=0;s<r.length-1;s++)a=P(this,n[i+s],e,s),a===x&&(a=this._$AH[s]),o||=!m(a)||a!==this._$AH[s],a===C?t=C:t!==C&&(t+=(a??"")+r[s+1]),this._$AH[s]=a}o&&!n&&this.j(t)}j(t){t===C?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,t??"")}}class L extends z{constructor(){super(...arguments),this.type=3}j(t){this.element[this.name]=t===C?void 0:t}}class M extends z{constructor(){super(...arguments),this.type=4}j(t){this.element.toggleAttribute(this.name,!!t&&t!==C)}}class R extends z{constructor(t,e,i,n,r){super(t,e,i,n,r),this.type=5}_$AI(t,e=this){if((t=P(this,t,e,0)??C)===x)return;const i=this._$AH,n=t===C&&i!==C||t.capture!==i.capture||t.once!==i.once||t.passive!==i.passive,r=t!==C&&(i===C||n);n&&this.element.removeEventListener(this.name,this,i),r&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){"function"==typeof this._$AH?this._$AH.call(this.options?.host??this.element,t):this._$AH.handleEvent(t)}}class j{constructor(t,e,i){this.element=t,this.type=6,this._$AN=void 0,this._$AM=e,this.options=i}get _$AU(){return this._$AM._$AU}_$AI(t){P(this,t)}}const D=o.litHtmlPolyfillSupport;D?.(E,H),(o.litHtmlVersions??=[]).push("3.2.1");const O=1;class I{constructor(t){}get _$AU(){return this._$AM._$AU}_$AT(t,e,i){this._$Ct=t,this._$AM=e,this._$Ci=i}_$AS(t,e){return this.update(t,e)}update(t,e){return this.render(...e)}}const U=(t=>(...e)=>({_$litDirective$:t,values:e}))(class extends I{constructor(t){if(super(t),t.type!==O||"class"!==t.name||t.strings?.length>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(t){return" "+Object.keys(t).filter((e=>t[e])).join(" ")+" "}update(t,[e]){if(void 0===this.st){this.st=new Set,void 0!==t.strings&&(this.nt=new Set(t.strings.join(" ").split(/\s/).filter((t=>""!==t))));for(const t in e)e[t]&&!this.nt?.has(t)&&this.st.add(t);return this.render(e)}const i=t.element.classList;for(const t of this.st)t in e||(i.remove(t),this.st.delete(t));for(const t in e){const n=!!e[t];n===this.st.has(t)||this.nt?.has(t)||(n?(i.add(t),this.st.add(t)):(i.remove(t),this.st.delete(t)))}return x}});t.NeumoPattern=class extends e.LitElement{constructor(){super(...arguments),this.pattern="z",this.loading=!1,this.content={main:""},this.withDropCap=!1,this.role=null,this.ariaLabel=null}render(){const t={"pattern-container":!0,[`${this.pattern}-pattern`]:!0};return e.html`
      <div class=${U(t)} 
